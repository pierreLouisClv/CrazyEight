...
public class PlayerTest {
    ...
    void getPlayableCardsTest() {
        ...
        assertEquals(hand.get(0), p.getPlayableCards(game.lastCardPlayed).get(0));
    ...
    void bestChoiceDoesNotChooseEight() {
        ...
        assertEquals(FourHeart, p.makeTheBestChoice(hand, game.lastCardPlayed));
    }
    ...
    void itShouldChooseFiveOfHearts() {
        ...
        assertEquals(FiveHeart,p.cardPlayedAtTheEndOfTheCombination(
                p.makeTheBestChoice(p.getPlayableCards(game.lastCardPlayed), game.lastCardPlayed), 3));
    }
